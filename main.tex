...
\begin{itemize}
\item They are strong enough to implant.
\item Small size permits chronic single-unit recording.
\item Small size, splayed geometry, high channel count allow fine-grained control.
\item May overcome stimulation current and voltage restrictions.
\end{itemize}
