...
\begin{abstract}
  ...
  Electrical control of the brain facilitates a variety of therapeutic and scientific goals, from treating sensory, motor, and cognitive defects to exploring the effects of disrupting or subtly modifying the brain's behaviour in real time.  This is limited by the brain's reaction to foreign matter: over a period of months, encapsulation isolates electrodes from neurons, allowing monitoring and control of the brain only over large spatial scales---often on the order of millimeters.

  Small electrodes ($<$ 10 $\mu$m) minimise encapsulation, and thus can both record single neurons for many months and precisely stimulate small groups of neurons.  We have developed an electrode design in which groups of electrodes support each other during insertion and then splay randomly in the brain, allowing long-term small-spatial-scale recording and stimulation [Guitchounts 2013].  However, the control problem for arrays of randomly placed small electrodes has not been investigated.  Moreover, the high impedance of small electrodes can require dangerous stimulation voltages.
  ...
  Multichannel, spatially distributed, micron-scale arrays allow long-term single-unit recordings, enabling new experiments investigating how the brain changes on longer timescales than have heretofore been possible.  In addition, current-steered control of stimulation inputs allows fine-grained control over small groups of neurons, permitting a wide variety of optimisations, such as controlling the brain to some desired response, or minimising the voltage or energy required in order to achieve a desired effect.
