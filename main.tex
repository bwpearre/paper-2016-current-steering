...
Recording of spontaneous activity in Area X was with an Intan RHD2000 amplifier at 20 kHz, with a hardware high-pass filter at 200 Hz.
...
intact spike-sized signals.\marginpar{Filtering would probably work
  better with the TDT than with the Intan\dots} We found this strongly
biased smoothing technique to produce fewer artifacts than the more
...
inspection.\marginpar{But now why not findpeaks $3\sigma$ or whatever,
  ...
  marginpar QWE to see why this is a good idea).  I reanalysed the old
  data this way and compared\dots see below.}
...
sensitive than the technique typical of acute or short-term response
measurements, in which a pronounced spike is often clearly visible.
...
A further, independent response-detection analysys was performed on
the data set: for each train of $n$ pulses, we labeled peaks greater
...
induce a response with probability 50\%.\marginpar{Search could even
  be conducted as above (although could do better) or terminated by
  estimating the error on the estimate.}
